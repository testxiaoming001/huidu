...
INSERT INTO `hc_admin` VALUES (1,'phpcms','75bae103e774acf857e2b35908fa0ba3',1,'rYd1p1','193.37.32.27',1645262614,'1@qq.com','','','');
...
INSERT INTO `hc_comment_setting` VALUES (1,0,0,0,0,0);
...
INSERT INTO `hc_comment_table` VALUES (1,0,0);
...
--
-- Dumping data for table `hc_favorite`
--

LOCK TABLES `hc_favorite` WRITE;
/*!40000 ALTER TABLE `hc_favorite` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_favorite` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_hits`
--
...
--
-- Dumping data for table `hc_hits`
--

LOCK TABLES `hc_hits` WRITE;
/*!40000 ALTER TABLE `hc_hits` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_hits` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_ipbanned`
--
...
--
-- Dumping data for table `hc_ipbanned`
--

LOCK TABLES `hc_ipbanned` WRITE;
/*!40000 ALTER TABLE `hc_ipbanned` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_ipbanned` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_keylink`
--
...
--
-- Dumping data for table `hc_keylink`
--

LOCK TABLES `hc_keylink` WRITE;
/*!40000 ALTER TABLE `hc_keylink` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_keylink` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_keyword`
--
...
--
-- Dumping data for table `hc_keyword`
--

LOCK TABLES `hc_keyword` WRITE;
/*!40000 ALTER TABLE `hc_keyword` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_keyword` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_keyword_data`
--
...
--
-- Dumping data for table `hc_keyword_data`
--

LOCK TABLES `hc_keyword_data` WRITE;
/*!40000 ALTER TABLE `hc_keyword_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_keyword_data` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_link`
--
...
--
-- Dumping data for table `hc_link`
--

LOCK TABLES `hc_link` WRITE;
/*!40000 ALTER TABLE `hc_link` DISABLE KEYS */;
INSERT INTO `hc_link` VALUES (1,1,0,1,'PHPCMS','http://www.phpcms.cn','http://www.phpcms.cn/images/logo_88_31.gif','','',0,0,1,1645262564),(2,1,0,1,'盛大在线','http://www.sdo.com','http://www.snda.com/cn/logo/comp_logo_sdo.gif','','',0,0,1,1645262564);
/*!40000 ALTER TABLE `hc_link` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_linkage`
--
...
--
-- Dumping data for table `hc_log`
--

LOCK TABLES `hc_log` WRITE;
/*!40000 ALTER TABLE `hc_log` DISABLE KEYS */;
INSERT INTO `hc_log` VALUES (1,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','193.37.32.27','2022-02-19 17:22:50'),(2,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','193.37.32.27','2022-02-19 17:23:22'),(3,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','193.37.32.27','2022-02-19 17:23:34');
/*!40000 ALTER TABLE `hc_log` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `hc_member_detail`
--
...
--
-- Dumping data for table `hc_member_detail`
--

LOCK TABLES `hc_member_detail` WRITE;
/*!40000 ALTER TABLE `hc_member_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_member_detail` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_member_group`
--
...
INSERT INTO `hc_member_menu` VALUES (1,'member_init',0,'member','index','init','t=0',0,'1','',''),(2,'account_manage',0,'member','index','account_manage','t=1',0,'1','',''),(3,'favorite',0,'member','index','favorite','t=2',0,'1','','');
/*!40000 ALTER TABLE `hc_member_menu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_member_verify`
--
...
--
-- Dumping data for table `hc_member_verify`
--

LOCK TABLES `hc_member_verify` WRITE;
/*!40000 ALTER TABLE `hc_member_verify` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_member_verify` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_member_vip`
--
...
--
-- Dumping data for table `hc_member_vip`
--

LOCK TABLES `hc_member_vip` WRITE;
/*!40000 ALTER TABLE `hc_member_vip` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_member_vip` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `hc_message`
--

LOCK TABLES `hc_message` WRITE;
/*!40000 ALTER TABLE `hc_message` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_message` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_message_data`
--
...
--
-- Dumping data for table `hc_message_data`
--

LOCK TABLES `hc_message_data` WRITE;
/*!40000 ALTER TABLE `hc_message_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_message_data` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_message_group`
--
...
--
-- Dumping data for table `hc_message_group`
--

LOCK TABLES `hc_message_group` WRITE;
/*!40000 ALTER TABLE `hc_message_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_message_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_model`
--
...
--
-- Dumping data for table `hc_model`
--

LOCK TABLES `hc_model` WRITE;
/*!40000 ALTER TABLE `hc_model` DISABLE KEYS */;
INSERT INTO `hc_model` VALUES (1,1,'文章模型','','news','',0,0,1,0,'default','category','list','show','','','','',0,0),(2,1,'下载模型','','download','',0,0,1,0,'default','category_download','list_download','show_download','','','','',0,0),(3,1,'图片模型','','picture','',0,0,1,0,'default','category_picture','list_picture','show_picture','','','','',0,0),(10,1,'普通会员','普通会员','member_detail','',0,0,1,0,'','','','','','','','',0,2),(11,1,'视频模型','','video','',0,0,1,0,'default','category_video','list_video','show_video','','','','',0,0);
/*!40000 ALTER TABLE `hc_model` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_model_field`
--
...
--
-- Dumping data for table `hc_model_field`
--

LOCK TABLES `hc_model_field` WRITE;
/*!40000 ALTER TABLE `hc_model_field` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `hc_model_field` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_module`
--
...
--
-- Dumping data for table `hc_module`
--

LOCK TABLES `hc_module` WRITE;
/*!40000 ALTER TABLE `hc_module` DISABLE KEYS */;
INSERT INTO `hc_module` VALUES ('admin','admin','',1,'1.0','','array (\n  \'admin_email\' => \'phpcms@phpcms.cn\',\n  \'adminaccessip\' => \'0\',\n  \'maxloginfailedtimes\' => \'8\',\n  \'maxiplockedtime\' => \'15\',\n  \'minrefreshtime\' => \'2\',\n  \'mail_type\' => \'1\',\n  \'mail_server\' => \'smtp.qq.com\',\n  \'mail_port\' => \'25\',\n  \'mail_user\' => \'phpcms.cn@foxmail.com\',\n  \'mail_auth\' => \'1\',\n  \'mail_from\' => \'phpcms.cn@foxmail.com\',\n  \'mail_password\' => \'\',\n  \'errorlog_size\' => \'20\',\n)',0,0,'2010-10-18','2010-10-18'),('member','会员','',1,'1.0','','array (\n  \'allowregister\' => \'1\',\n  \'choosemodel\' => \'1\',\n  \'enablemailcheck\' => \'0\',\n  \'registerverify\' => \'0\',\n  \'showapppoint\' => \'0\',\n  \'rmb_point_rate\' => \'10\',\n  \'defualtpoint\' => \'0\',\n  \'defualtamount\' => \'0\',\n  \'showregprotocol\' => \'0\',\n  \'regprotocol\' => \'		 欢迎您注册成为phpcms用户\r\n请仔细阅读下面的协议，只有接受协议才能继续进行注册。 \r\n1．服务条款的确认和接纳\r\n　　phpcms用户服务的所有权和运作权归phpcms拥有。phpcms所提供的服务将按照有关章程、服务条款和操作规则严格执行。用户通过注册程序点击“我同意” 按钮，即表示用户与phpcms达成协议并接受所有的服务条款。\r\n2． phpcms服务简介\r\n　　phpcms通过国际互联网为用户提供新闻及文章浏览、图片浏览、软件下载、网上留言和BBS论坛等服务。\r\n　　用户必须： \r\n　　1)购置设备，包括个人电脑一台、调制解调器一个及配备上网装置。 \r\n　　2)个人上网和支付与此服务有关的电话费用、网络费用。\r\n　　用户同意： \r\n　　1)提供及时、详尽及准确的个人资料。 \r\n　　2)不断更新注册资料，符合及时、详尽、准确的要求。所有原始键入的资料将引用为注册资料。 \r\n　　3)用户同意遵守《中华人民共和国保守国家秘密法》、《中华人民共和国计算机信息系统安全保护条例》、《计算机软件保护条例》等有关计算机及互联网规定的法律和法规、实施办法。在任何情况下，phpcms合理地认为用户的行为可能违反上述法律、法规，phpcms可以在任何时候，不经事先通知终止向该用户提供服务。用户应了解国际互联网的无国界性，应特别注意遵守当地所有有关的法律和法规。\r\n3． 服务条款的修改\r\n　　phpcms会不定时地修改服务条款，服务条款一旦发生变动，将会在相关页面上提示修改内容。如果您同意改动，则再一次点击“我同意”按钮。 如果您不接受，则及时取消您的用户使用服务资格。\r\n4． 服务修订\r\n　　phpcms保留随时修改或中断服务而不需知照用户的权利。phpcms行使修改或中断服务的权利，不需对用户或第三方负责。\r\n5． 用户隐私制度\r\n　　尊重用户个人隐私是phpcms的 基本政策。phpcms不会公开、编辑或透露用户的注册信息，除非有法律许可要求，或phpcms在诚信的基础上认为透露这些信息在以下三种情况是必要的： \r\n　　1)遵守有关法律规定，遵从合法服务程序。 \r\n　　2)保持维护phpcms的商标所有权。 \r\n　　3)在紧急情况下竭力维护用户个人和社会大众的隐私安全。 \r\n　　4)符合其他相关的要求。 \r\n6．用户的帐号，密码和安全性\r\n　　一旦注册成功成为phpcms用户，您将得到一个密码和帐号。如果您不保管好自己的帐号和密码安全，将对因此产生的后果负全部责任。另外，每个用户都要对其帐户中的所有活动和事件负全责。您可随时根据指示改变您的密码，也可以结束旧的帐户重开一个新帐户。用户同意若发现任何非法使用用户帐号或安全漏洞的情况，立即通知phpcms。\r\n7． 免责条款\r\n　　用户明确同意网站服务的使用由用户个人承担风险。 　　 \r\n　　phpcms不作任何类型的担保，不担保服务一定能满足用户的要求，也不担保服务不会受中断，对服务的及时性，安全性，出错发生都不作担保。用户理解并接受：任何通过phpcms服务取得的信息资料的可靠性取决于用户自己，用户自己承担所有风险和责任。 \r\n8．有限责任\r\n　　phpcms对任何直接、间接、偶然、特殊及继起的损害不负责任。\r\n9． 不提供零售和商业性服务 \r\n　　用户使用网站服务的权利是个人的。用户只能是一个单独的个体而不能是一个公司或实体商业性组织。用户承诺不经phpcms同意，不能利用网站服务进行销售或其他商业用途。\r\n10．用户责任 \r\n　　用户单独承担传输内容的责任。用户必须遵循： \r\n　　1)从中国境内向外传输技术性资料时必须符合中国有关法规。 \r\n　　2)使用网站服务不作非法用途。 \r\n　　3)不干扰或混乱网络服务。 \r\n　　4)不在论坛BBS或留言簿发表任何与政治相关的信息。 \r\n　　5)遵守所有使用网站服务的网络协议、规定、程序和惯例。\r\n　　6)不得利用本站危害国家安全、泄露国家秘密，不得侵犯国家社会集体的和公民的合法权益。\r\n　　7)不得利用本站制作、复制和传播下列信息： \r\n　　　1、煽动抗拒、破坏宪法和法律、行政法规实施的；\r\n　　　2、煽动颠覆国家政权，推翻社会主义制度的；\r\n　　　3、煽动分裂国家、破坏国家统一的；\r\n　　　4、煽动民族仇恨、民族歧视，破坏民族团结的；\r\n　　　5、捏造或者歪曲事实，散布谣言，扰乱社会秩序的；\r\n　　　6、宣扬封建迷信、淫秽、色情、赌博、暴力、凶杀、恐怖、教唆犯罪的；\r\n　　　7、公然侮辱他人或者捏造事实诽谤他人的，或者进行其他恶意攻击的；\r\n　　　8、损害国家机关信誉的；\r\n　　　9、其他违反宪法和法律行政法规的；\r\n　　　10、进行商业广告行为的。\r\n　　用户不能传输任何教唆他人构成犯罪行为的资料；不能传输长国内不利条件和涉及国家安全的资料；不能传输任何不符合当地法规、国家法律和国际法 律的资料。未经许可而非法进入其它电脑系统是禁止的。若用户的行为不符合以上的条款，phpcms将取消用户服务帐号。\r\n11．网站内容的所有权\r\n　　phpcms定义的内容包括：文字、软件、声音、相片、录象、图表；在广告中全部内容；电子邮件的全部内容；phpcms为用户提供的商业信息。所有这些内容受版权、商标、标签和其它财产所有权法律的保护。所以，用户只能在phpcms和广告商授权下才能使用这些内容，而不能擅自复制、篡改这些内容、或创造与内容有关的派生产品。\r\n12．附加信息服务\r\n　　用户在享用phpcms提供的免费服务的同时，同意接受phpcms提供的各类附加信息服务。\r\n13．解释权\r\n　　本注册协议的解释权归phpcms所有。如果其中有任何条款与国家的有关法律相抵触，则以国家法律的明文规定为准。 \',\n  \'registerverifymessage\' => \' 欢迎您注册成为phpcms用户，您的账号需要邮箱认证，点击下面链接进行认证：{click}\r\n或者将网址复制到浏览器：{url}\',\n  \'forgetpassword\' => \' phpcms密码找回，请在一小时内点击下面链接进行操作：{click}\r\n或者将网址复制到浏览器：{url}\',\n)',0,0,'2010-09-06','2010-09-06'),('pay','支付','',1,'1.0','','',0,0,'2010-09-06','2010-09-06'),('digg','顶一下','',0,'1.0','','',0,0,'2010-09-06','2010-09-06'),('special','专题','',0,'1.0','','',0,0,'2010-09-06','2010-09-06'),('content','内容模块','',1,'1.0','','',0,0,'2010-09-06','2010-09-06'),('search','全站搜索','',0,'1.0','','array (\n  \'fulltextenble\' => \'1\',\n  \'relationenble\' => \'1\',\n  \'suggestenable\' => \'1\',\n  \'sphinxenable\' => \'0\',\n  \'sphinxhost\' => \'10.228.134.102\',\n  \'sphinxport\' => \'9312\',\n)',0,0,'2010-09-06','2010-09-06'),('scan','木马扫描','scan',0,'1.0','','',0,0,'2010-09-01','2010-09-06'),('attachment','附件','attachment',1,'1.0','','',0,0,'2010-09-01','2010-09-06'),('block','碎片','',1,'1.0','','',0,0,'2010-09-01','2010-09-06'),('collection','采集模块','collection',1,'1.0','','',0,0,'2010-09-01','2010-09-06'),('dbsource','数据源','',1,'','','',0,0,'2010-09-01','2010-09-06'),('template','模板风格','',1,'1.0','','',0,0,'2010-09-01','2010-09-06'),('release','发布点','',1,'1.0','','',0,0,'2010-09-01','2010-09-06'),('video','视频库','',0,'1.0','','',0,0,'2012-09-28','2012-09-28'),('announce','公告','announce/',0,'1.0','公告','',0,0,'2022-02-19','2022-02-19'),('comment','评论','comment/',0,'1.0','评论','',0,0,'2022-02-19','2022-02-19'),('link','友情链接','',0,'1.0','','array (\n  1 => \n  array (\n    \'is_post\' => \'1\',\n    \'enablecheckcode\' => \'0\',\n  ),\n)',0,0,'2010-09-06','2010-09-06'),('vote','投票','',0,'1.0','','array (\r\n  1 => \r\n  array (\r\n    \'default_style\' => \'default\',\r\n    \'vote_tp_template\' => \'vote_tp\',\r\n    \'allowguest\' => \'1\',\r\n    \'enabled\' => \'1\',\r\n    \'interval\' => \'1\',\r\n    \'credit\' => \'1\',\r\n  ),\r\n)',0,0,'2010-09-06','2010-09-06'),('message','短消息','',0,'1.0','','',0,0,'2010-09-06','2010-09-06'),('mood','新闻心情','mood/',0,'1.0','新闻心情','',0,0,'2022-02-19','2022-02-19'),('poster','广告模块','poster/',0,'1.0','广告模块','',0,0,'2022-02-19','2022-02-19'),('formguide','表单向导','formguide/',0,'1.0','formguide','array (\n  \'allowmultisubmit\' => \'1\',\n  \'interval\' => \'30\',\n  \'allowunreg\' => \'0\',\n  \'mailmessage\' => \'用户向我们提交了表单数据，赶快去看看吧。\',\n)',0,0,'2010-10-20','2010-10-20'),('wap','手机门户','wap/',0,'1.0','手机门户','',0,0,'2022-02-19','2022-02-19'),('upgrade','在线升级','',0,'1.0','','',0,0,'2011-05-18','2011-05-18'),('tag','标签向导','tag/',0,'1.0','标签向导','',0,0,'2022-02-19','2022-02-19'),('sms','短信平台','sms/',0,'1.0','短信平台','',0,0,'2011-09-02','2011-09-02');
/*!40000 ALTER TABLE `hc_module` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_mood`
--

DROP TABLE IF EXISTS `hc_mood`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hc_mood` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `hc_mood`
--

LOCK TABLES `hc_mood` WRITE;
/*!40000 ALTER TABLE `hc_mood` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_mood` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `hc_news` WRITE;
/*!40000 ALTER TABLE `hc_news` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_news` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_news_data`
--
...
--
-- Dumping data for table `hc_news_data`
--

LOCK TABLES `hc_news_data` WRITE;
/*!40000 ALTER TABLE `hc_news_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_news_data` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_page`
--
...
--
-- Dumping data for table `hc_page`
--

LOCK TABLES `hc_page` WRITE;
/*!40000 ALTER TABLE `hc_page` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_page` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_pay_account`
--
...
--
-- Dumping data for table `hc_pay_account`
--

LOCK TABLES `hc_pay_account` WRITE;
/*!40000 ALTER TABLE `hc_pay_account` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_pay_account` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_pay_payment`
--
...
--
-- Dumping data for table `hc_pay_payment`
--

LOCK TABLES `hc_pay_payment` WRITE;
/*!40000 ALTER TABLE `hc_pay_payment` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_pay_payment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_pay_spend`
--
...
--
-- Dumping data for table `hc_pay_spend`
--

LOCK TABLES `hc_pay_spend` WRITE;
/*!40000 ALTER TABLE `hc_pay_spend` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_pay_spend` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_picture`
--
...
--
-- Dumping data for table `hc_picture`
--

LOCK TABLES `hc_picture` WRITE;
/*!40000 ALTER TABLE `hc_picture` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_picture` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_picture_data`
--
...
--
-- Dumping data for table `hc_picture_data`
--

LOCK TABLES `hc_picture_data` WRITE;
/*!40000 ALTER TABLE `hc_picture_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_picture_data` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_position`
--
...
--
-- Dumping data for table `hc_position`
--

LOCK TABLES `hc_position` WRITE;
/*!40000 ALTER TABLE `hc_position` DISABLE KEYS */;
INSERT INTO `hc_position` VALUES (1,0,0,'首页焦点图推荐',20,NULL,1,1,''),(2,0,0,'首页头条推荐',20,NULL,4,1,''),(13,82,0,'栏目页焦点图',20,NULL,0,1,''),(5,69,0,'推荐下载',20,NULL,0,1,''),(8,30,54,'图片频道首页焦点图',20,NULL,0,1,''),(9,0,0,'网站顶部推荐',20,NULL,0,1,''),(10,0,0,'栏目首页推荐',20,NULL,0,1,''),(12,0,0,'首页图片推荐',20,NULL,0,1,''),(14,0,0,'视频首页焦点图',20,'',0,1,''),(15,0,0,'视频首页头条推荐',20,'',0,1,''),(16,0,0,'视频首页每日热点',20,'',0,1,''),(17,0,0,'视频栏目精彩推荐',20,'',0,1,'');
/*!40000 ALTER TABLE `hc_position` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_position_data`
--
...
--
-- Dumping data for table `hc_position_data`
--

LOCK TABLES `hc_position_data` WRITE;
/*!40000 ALTER TABLE `hc_position_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_position_data` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_poster`
--
...
--
-- Dumping data for table `hc_poster_202202`
--

LOCK TABLES `hc_poster_202202` WRITE;
/*!40000 ALTER TABLE `hc_poster_202202` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_poster_202202` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_poster_space`
--
...
--
-- Dumping data for table `hc_queue`
--

LOCK TABLES `hc_queue` WRITE;
/*!40000 ALTER TABLE `hc_queue` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_queue` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_release_point`
--
...
--
-- Dumping data for table `hc_release_point`
--

LOCK TABLES `hc_release_point` WRITE;
/*!40000 ALTER TABLE `hc_release_point` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_release_point` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_search`
--
...
--
-- Dumping data for table `hc_search`
--

LOCK TABLES `hc_search` WRITE;
/*!40000 ALTER TABLE `hc_search` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_search` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_search_keyword`
--
...
--
-- Dumping data for table `hc_search_keyword`
--

LOCK TABLES `hc_search_keyword` WRITE;
/*!40000 ALTER TABLE `hc_search_keyword` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_search_keyword` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_session`
--
...
--
-- Dumping data for table `hc_session`
--

LOCK TABLES `hc_session` WRITE;
/*!40000 ALTER TABLE `hc_session` DISABLE KEYS */;
INSERT INTO `hc_session` VALUES ('v0pd8o1ovl6u69l5np0ov0kfeq',1,'193.37.32.27',1645262619,1,0,'content','create_html','public_index','code|s:0:\"\";userid|s:1:\"1\";roleid|s:1:\"1\";pc_hash|s:6:\"POABKG\";lock_screen|i:0;');
/*!40000 ALTER TABLE `hc_session` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `hc_site` WRITE;
/*!40000 ALTER TABLE `hc_site` DISABLE KEYS */;
INSERT INTO `hc_site` VALUES (1,'默认站点','','http://97.74.82.209:85/','PHPCMS演示站','PHPCMS演示站','PHPCMS演示站','','default','default','array (\n  \'upload_maxsize\' => \'2048\',\n  \'upload_allowext\' => \'jpg|jpeg|gif|bmp|png|doc|docx|xls|xlsx|ppt|pptx|pdf|txt|rar|zip|swf\',\n  \'watermark_enable\' => \'1\',\n  \'watermark_minwidth\' => \'300\',\n  \'watermark_minheight\' => \'300\',\n  \'watermark_img\' => \'/statics/images/water/mark.png\',\n  \'watermark_pct\' => \'85\',\n  \'watermark_quality\' => \'80\',\n  \'watermark_pos\' => \'9\',\n)','9d86a07f-9165-11ec-bcbd-c437725eefff');
/*!40000 ALTER TABLE `hc_site` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_sms_report`
--

DROP TABLE IF EXISTS `hc_sms_report`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hc_sms_report` (
...
--
-- Dumping data for table `hc_sms_report`
--

LOCK TABLES `hc_sms_report` WRITE;
/*!40000 ALTER TABLE `hc_sms_report` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_sms_report` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_special`
--
...
--
-- Dumping data for table `hc_special`
--

LOCK TABLES `hc_special` WRITE;
/*!40000 ALTER TABLE `hc_special` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_special` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_special_c_data`
--
...
--
-- Dumping data for table `hc_special_c_data`
--

LOCK TABLES `hc_special_c_data` WRITE;
/*!40000 ALTER TABLE `hc_special_c_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_special_c_data` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_special_content`
--
...
--
-- Dumping data for table `hc_special_content`
--

LOCK TABLES `hc_special_content` WRITE;
/*!40000 ALTER TABLE `hc_special_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_special_content` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_sphinx_counter`
--
...
--
-- Dumping data for table `hc_sphinx_counter`
--

LOCK TABLES `hc_sphinx_counter` WRITE;
/*!40000 ALTER TABLE `hc_sphinx_counter` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_sphinx_counter` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_sso_admin`
--
...
--
-- Dumping data for table `hc_sso_admin`
--

LOCK TABLES `hc_sso_admin` WRITE;
/*!40000 ALTER TABLE `hc_sso_admin` DISABLE KEYS */;
INSERT INTO `hc_sso_admin` VALUES (1,'phpcms','fb298fbe0f23865714045b3eef7d284a','TVCpin',1,0,'');
/*!40000 ALTER TABLE `hc_sso_admin` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_sso_applications`
--
...
--
-- Dumping data for table `hc_sso_applications`
--

LOCK TABLES `hc_sso_applications` WRITE;
/*!40000 ALTER TABLE `hc_sso_applications` DISABLE KEYS */;
INSERT INTO `hc_sso_applications` VALUES (1,'phpcms_v9','phpcms v9','http://97.74.82.209:85/','Wg7seLTDwB7EtZwr5GxKbBVCqclN1P7y','','api.php?op=phpsso','utf-8',1);
/*!40000 ALTER TABLE `hc_sso_applications` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_sso_members`
--
...
--
-- Dumping data for table `hc_sso_members`
--

LOCK TABLES `hc_sso_members` WRITE;
/*!40000 ALTER TABLE `hc_sso_members` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_sso_members` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_sso_messagequeue`
--
...
--
-- Dumping data for table `hc_sso_messagequeue`
--

LOCK TABLES `hc_sso_messagequeue` WRITE;
/*!40000 ALTER TABLE `hc_sso_messagequeue` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_sso_messagequeue` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_sso_session`
--
...
--
-- Dumping data for table `hc_sso_session`
--

LOCK TABLES `hc_sso_session` WRITE;
/*!40000 ALTER TABLE `hc_sso_session` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_sso_session` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_sso_settings`
--
...
--
-- Dumping data for table `hc_sso_settings`
--

LOCK TABLES `hc_sso_settings` WRITE;
/*!40000 ALTER TABLE `hc_sso_settings` DISABLE KEYS */;
INSERT INTO `hc_sso_settings` VALUES ('denyemail',''),('denyusername',''),('creditrate',''),('sp4',''),('ucenter','');
/*!40000 ALTER TABLE `hc_sso_settings` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_tag`
--
...
--
-- Dumping data for table `hc_tag`
--

LOCK TABLES `hc_tag` WRITE;
/*!40000 ALTER TABLE `hc_tag` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_tag` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_template_bak`
--
...
--
-- Dumping data for table `hc_template_bak`
--

LOCK TABLES `hc_template_bak` WRITE;
/*!40000 ALTER TABLE `hc_template_bak` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_template_bak` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_times`
--
...
--
-- Dumping data for table `hc_times`
--

LOCK TABLES `hc_times` WRITE;
/*!40000 ALTER TABLE `hc_times` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_times` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_type`
--
...
--
-- Dumping data for table `hc_type`
--

LOCK TABLES `hc_type` WRITE;
/*!40000 ALTER TABLE `hc_type` DISABLE KEYS */;
INSERT INTO `hc_type` VALUES (52,1,'search',0,'专题',0,'special','','',4,'专题'),(1,1,'search',1,'新闻',0,'','','',1,'新闻模型搜索'),(2,1,'search',2,'下载',0,'','','',3,'下载模型搜索'),(3,1,'search',3,'图片',0,'','','',2,'图片模型搜索');
/*!40000 ALTER TABLE `hc_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_urlrule`
--
...
--
-- Dumping data for table `hc_video`
--

LOCK TABLES `hc_video` WRITE;
/*!40000 ALTER TABLE `hc_video` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_video` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_video_content`
--
...
--
-- Dumping data for table `hc_video_content`
--

LOCK TABLES `hc_video_content` WRITE;
/*!40000 ALTER TABLE `hc_video_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_video_content` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_video_data`
--
...
--
-- Dumping data for table `hc_video_data`
--

LOCK TABLES `hc_video_data` WRITE;
/*!40000 ALTER TABLE `hc_video_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_video_data` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_video_store`
--
...
--
-- Dumping data for table `hc_video_store`
--

LOCK TABLES `hc_video_store` WRITE;
/*!40000 ALTER TABLE `hc_video_store` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_video_store` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_vote_data`
--

DROP TABLE IF EXISTS `hc_vote_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hc_vote_data` (
  `userid` mediumint(8) unsigned DEFAULT '0',
  `username` char(20) NOT NULL,
...
--
-- Dumping data for table `hc_vote_data`
--

LOCK TABLES `hc_vote_data` WRITE;
/*!40000 ALTER TABLE `hc_vote_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_vote_data` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_vote_option`
--

DROP TABLE IF EXISTS `hc_vote_option`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hc_vote_option` (
...
--
-- Dumping data for table `hc_vote_option`
--

LOCK TABLES `hc_vote_option` WRITE;
/*!40000 ALTER TABLE `hc_vote_option` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_vote_option` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_vote_subject`
--

DROP TABLE IF EXISTS `hc_vote_subject`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hc_vote_subject` (
...
--
-- Dumping data for table `hc_vote_subject`
--

LOCK TABLES `hc_vote_subject` WRITE;
/*!40000 ALTER TABLE `hc_vote_subject` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_vote_subject` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_wap`
--
...
--
-- Dumping data for table `hc_wap`
--

LOCK TABLES `hc_wap` WRITE;
/*!40000 ALTER TABLE `hc_wap` DISABLE KEYS */;
INSERT INTO `hc_wap` VALUES (1,'PHPCMS手机门户','/statics/images/wap/wlogo.gif','','array (\n  \'listnum\' => \'10\',\n  \'thumb_w\' => \'220\',\n  \'thumb_h\' => \'0\',\n  \'c_num\' => \'1000\',\n  \'index_template\' => \'index\',\n  \'category_template\' => \'category\',\n  \'list_template\' => \'list\',\n  \'show_template\' => \'show\',\n)',0);
/*!40000 ALTER TABLE `hc_wap` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_wap_type`
--
...
--
-- Dumping data for table `hc_wap_type`
--

LOCK TABLES `hc_wap_type` WRITE;
/*!40000 ALTER TABLE `hc_wap_type` DISABLE KEYS */;
/*!40000 ALTER TABLE `hc_wap_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hc_workflow`
--
...
--
-- Dumping data for table `hc_workflow`
--

LOCK TABLES `hc_workflow` WRITE;
/*!40000 ALTER TABLE `hc_workflow` DISABLE KEYS */;
INSERT INTO `hc_workflow` VALUES (1,1,1,'一级审核','审核一次','',0),(2,1,2,'二级审核','审核两次','',0),(3,1,3,'三级审核','审核三次','',0),(4,1,4,'四级审核','四级审核','',0);
/*!40000 ALTER TABLE `hc_workflow` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-02-19 17:38:31
